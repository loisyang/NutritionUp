...
s.Button_23.onTouchEnd ->
	...
	s.Main.scrollVertical = true
	s.Main.scrollHorizontal = false
	s.Main.directionLock = true
	s.Main.directionLockThreshold = y: 0
	s.Main.height = 1794
	s.Main.width = 750
	s.Main.superLayer = scrollFrame.content
